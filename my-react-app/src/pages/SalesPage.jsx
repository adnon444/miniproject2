...
function SalesPage() {
    ...
    return (
        <div className="SalesPage FancyBox">

            <header><img src='https://i.pinimg.com/736x/0c/b9/f8/0cb9f88a59191752626863c492e99ec7.jpg' height="400px" width="600px"></img></header>
            <h2>Sneaker Sales</h2>
            <h3>2024 was a big year for sneaker sales, and in particular sneaker sales in the secondary market, as indicated by the data below. The top performing brands Nike, Adidas, and Jordan brand all take the center stage. Click the buttons below to sort the data to your preference.</h3>
